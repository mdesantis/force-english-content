...
help search initiated through the Visual Studio code editor by pressing F1.
Redirection is performed quickly before you even reach out to the server for the
localised site.
